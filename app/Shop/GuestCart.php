...
class GuestCart
{
    ...
    public function add($user, $item_id,$qty=1, $extras=[], $drinks=[], $options=[], $coupon=null, $pickup_type, $branch_id, $car_type=null, $car_color=null)
    {
        CartProduct::create([
        ...
        $this->update((isset($user->id))?$user->id:$user);
    }
