...
@if (is_permited('browse_admins') == 1)
    <div class="col-md-12 col-xl-12">
        <div class="card">
            ...
            <form action="{{ aurl('banners/update/'.$banner->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $banner->title_ar }}" name="title_ar" class="form-control"
                            id="title_ar">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="floating-label" for="description_ar">{{ trans('admin.Description Ar') }} <span
                                class="redStar">*</span></label>
                        <input type="text" value="{{ $banner->description_ar }}" name="description_ar" class="form-control"
                            id="description_ar">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="floating-label" for="description_en">{{ trans('admin.Description En') }} <span
                                class="redStar">*</span></label>
                        <input type="text" value="{{ $banner->description_en }}" name="description_en" class="form-control"
                            id="description_en">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-pill btn-outline-primary btn-air-primary"
                            ...
                            <img src="{{ ($banner->media()->exists())?$banner->media->url : asset('dashboard/assets/images/placeholder-image.png') }}"
