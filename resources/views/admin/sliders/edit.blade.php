                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="status" class="form-select" id="status">
                            ...
                            <option value="0" {{($slider->status == 0)?'selected':''}}>{{trans('admin.DeActive')}}</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-pill btn-outline-primary btn-air-primary"
                            ...
                            <img src="{{ ($slider->image()->exists())?$slider->image->url : asset('dashboard/assets/images/placeholder-image.png') }}"
