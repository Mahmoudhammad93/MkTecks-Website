...
@if (is_permited('browse_admins') == 1)
    ...
    <div class="col-md-12 col-xl-12">
        <div class="card">
            ...
            <form action="{{ aurl('team/create') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="floating-label" for="position_ar">{{ trans('admin.Position Ar') }} <span
                                class="redStar">*</span></label>
                        <input type="text" value="{{ old('position_ar') }}" name="position_ar" class="form-control"
                            id="position_ar">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="floating-label" for="position_en">{{ trans('admin.Position En') }} <span
                                class="redStar">*</span></label>
                        <input type="text" value="{{ old('position_en') }}" name="position_en" class="form-control"
                            id="position_en">
                    </div>
